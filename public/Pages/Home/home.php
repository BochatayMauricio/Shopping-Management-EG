                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto">
                                    <a href="../../Pages/News/News.php" class="btn btn-link p-0 text-decoration-none fw-bold" data-bs-toggle="modal" data-bs-target="#verMas_<?php echo $novedad['id']; ?>">Leer más →</a>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="modal fade" id="verMas_<?php echo $novedad['id']; ?>" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content shadow-lg">
                                <div class="modal-header">
                                    <h5 class="modal-title"><?php echo htmlspecialchars($novedad['title']); ?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body p-4">
                                    <p><strong>Por:</strong> <?php echo htmlspecialchars($novedad['author']); ?></p>
                                    <p><strong>Fecha:</strong> <?php echo $novedad['date']; ?></p>
                                    <p><?php echo htmlspecialchars($novedad['description']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
